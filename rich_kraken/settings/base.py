"""
Django settings for rich_kraken project.
...
DJANGO_SETTINGS_MODULE = os.getenv("DJANGO_SETTINGS_MODULE", "rich_kraken.settings.local")
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,
        "OPTIONS": {
            "environment": "rich_kraken.jinja2.environment",
        },
    },
    {
...
WSGI_APPLICATION = "rich_kraken.wsgi.application"
